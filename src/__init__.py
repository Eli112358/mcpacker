...
class DataPacker(DataPack):
    ...
    def recipes(self):
        ...
        self.tick.add_text("advancement revoke @a from {}\n".format(resolve("recipes/root", self)))
    ...
    def __load_dependancies(self):
        ...
        self.packs = {}
        for name in data:
            print("[dependancies] Loading '{}'...".format(name))
            self.packs[name] = DataPack.load("out/" + name)
        print("[dependancies] Complete.")
